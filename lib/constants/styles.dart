...
final kObsColor1 = Color(0xFFB3DCE1);
final kObsColor2 = Color(0xFFE1B3BB);
final kObsColor3 = Color(0xFFE1CFB3);
final kBackgroundColor = Color(0xFFF6F7FB);
final kButtonColor = Color(0xFF00A3AD);
final kMarqueeColor = Color(0xFF17535b);
final kRejectButtonColor = Color(0xFFD14D4D);
final kBoxInActiveColor = Color(0xFFDFDFDF);
final kBottomNavColor = Color(0xFFED8A87);
final kFABColor = Color(0xFF384064);
final kToastColor = Color(0xFF00A3AD);//Color(0xFFE35858);
final kPositiveToastColor = Color(0xFF00A3AD);//Color(0xFF0AA42F);
final kLoginTextFieldFillColor = Color(0xFFFFFFFF);
...
final topHeaderBar = Color(0xFFcee7fe);
final backgroundColor = Color(0xFFFEF4E5);
final ktableColor = Color(0xFFd9d9d9);
...
TextStyle kMarqueeTextStyle = TextStyle(
  fontSize: 20,
  color: Color(0xFF01A1AB),//kMarqueeColor,
  fontWeight: FontWeight.w600,
);
...
TextStyle kConsentNumberTextStyle =
    GoogleFonts.poppins(fontWeight: FontWeight.bold,fontSize: 14, color: Colors.black, );
TextStyle kUnderlineTextStyle =
    GoogleFonts.poppins(fontWeight: FontWeight.bold,fontSize: 17, color: Colors.black,  decoration: TextDecoration.underline, );
TextStyle kConsentTableTextStyle =
    GoogleFonts.poppins(fontWeight: FontWeight.bold,fontSize: 15, color: Colors.black, );
TextStyle kConsentsubHeadTextStyle =
    GoogleFonts.poppins(fontWeight: FontWeight.w600,fontSize: 15, color: Colors.black, );
