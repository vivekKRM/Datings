...
class EditCertificationOfCompetency extends StatefulWidget {
  EditCertificationOfCompetency(
      {Key? key,
      required this.title,
  ...
  @override
  _EditCertificationOfCompetencyState createState() =>
      _EditCertificationOfCompetencyState();
}

class _EditCertificationOfCompetencyState
    extends State<EditCertificationOfCompetency> {
  String user_id = '';
  late FToast fToast;
  ...
  Future<void> getCertificateDetails(String user_id) async {
    if (user_id != "") {
      final requestBody = {"user_id": user_id};
      widget.appManager.apis
          .getCertificateCompetency(
                    ...
                    Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          Map<String, dynamic> arguments = {
                            'update': false,
                            'index': (certificate.length + 1).toString(),
                            'add': true
                          };
                          ...
                          children: [
                            Container(
                              ...
                              child: Icon(
                                Icons.add,
                                color:
                                    Colors.white, // Set your desired icon color
                              ),
                            ),
                            SizedBox(
                                width:
